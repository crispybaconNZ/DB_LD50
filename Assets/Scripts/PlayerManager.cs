...
public class PlayerManager : MonoBehaviour {
    ...
    private int score;
    private float timeSinceLastUpdate = 2.0f;
    ...
    private void Update() {
        ...
        if (currentMode == PlayerMode.PlacingDefence && currentDefence != null) {
            ...
            if (playerControls.Player.PlaceDefence.WasPerformedThisFrame()) {
            ...
            } else if (playerControls.Player.CancelPlaceDefence.WasPerformedThisFrame()) {
                // player clicked the right mouse button so cancel placement
                currentDefence = null;
                currentMode = PlayerMode.Viewing;
                uiManager.ClearMessage();
